...
import { X, Sun, Flower2, Terminal, Droplets, Snowflake, Sparkles, Lock, Music, Music2 } from 'lucide-react';
...
const THEMES: { id: Theme; label: string; icon: React.ReactNode; swatch: string }[] = [
  ...
  { id: 'kaleido', label: '時空神', icon: <Sparkles size={22} />, swatch: 'bg-[#06041a] border-amber-400' },
];
